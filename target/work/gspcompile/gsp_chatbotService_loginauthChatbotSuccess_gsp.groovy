...
class gsp_chatbotService_loginauthChatbotSuccess_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/login/authChatbotSuccess.gsp" }
public Object run() {
Writer out = getOut()
