...
class gsp_chatbotService_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('javascript','asset',18,['src':("jquery-ui")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',19,['src':("bootbox.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',20,['src':("crossOriginRequest.js")],-1)
printHtmlPart(6)
...
createTagBody(1, {->
printHtmlPart(9)
invokeTag('render','g',35,['template':("/layouts/banner")],-1)
printHtmlPart(10)
invokeTag('layoutBody','g',37,[:],-1)
printHtmlPart(10)
invokeTag('render','g',39,['template':("/layouts/footer")],-1)
printHtmlPart(11)
})
invokeTag('captureBody','sitemesh',41,['class':("container-fluid")],1)
printHtmlPart(12)
}
