...
class gsp_chatbotService_layoutsnone_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/layouts/none.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('captureBody','sitemesh',30,['class':("container-fluid")],1)
printHtmlPart(9)
}
